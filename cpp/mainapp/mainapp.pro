...
LIBS += "C:\\Program Files\\Microsoft SDKs\\Windows\\v7.1\\Lib\\d2d1.lib" -L"$(SolutionDir)/../d2dplayer/cpp/lib" avcodec.lib avdevice.lib avfilter.lib avformat.lib avutil.lib swscale.lib swresample.lib winmm.lib ws2_32.lib
