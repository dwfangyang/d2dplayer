...
//	HMODULE ab = LoadLibrary(L"D:\\duowan\\yydev\\yy\\dev572067\\dwutility.dll");
//	if ( !ab )
//	{
//		//MessageBox(0,QString("wrong:%1").arg(GetLastError()).toStdWString().c_str(),0,0);
//	}
//
